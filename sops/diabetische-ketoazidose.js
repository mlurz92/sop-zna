            ...
            },
            {
                ...
                <div class="dispo">
                    <section class="dispo-card dispo-gruen">
                        ...
                        <p class="dispo-spec">Nicht vorgesehen &ndash; auch die leichte DKA wird stationär behandelt.</p>
                    ...
                    <section class="dispo-card dispo-gelb">
                        ...
                        <p class="dispo-spec">Leichte DKA (pH &lt; 7,3): Normalstation; mittlere/schwere DKA: IMC/ITS.</p>
                ...
                <div class="table-wrap">
                    <table>
                        <thead>
                            <tr><th>Parameter</th><th>Leicht</th><th>Mittel</th><th>Schwer</th></tr>
                        </thead>
                        <tbody>
                            ...
                            <tr><td><strong>Disposition</strong></td><td>GELB (Normalstation)</td><td>ROT (IMC)</td><td>ROT (ITS)</td></tr>
                        </tbody>
                    </table>
                </div>`
            }
