            ...
            },
            {
                ...
                <div class="dispo">
                    <section class="dispo-card dispo-gruen">
                        ...
                        <p class="dispo-spec">Nur bei bekannter Metastasierung ohne neue neurologische Defizite und gesicherter onkologischer Anbindung.</p>
                    ...
                    <section class="dispo-card dispo-gelb">
                        ...
                        <li class="dispo-contact"><span class="dispo-fach">Neurochirurgie (NCH)</span><span class="dispo-tel">4466</span></li>
                        </ul>
                        <p class="dispo-spec">Bei Hirndruckzeichen sofortige Neurochirurgie (4466).</p>
