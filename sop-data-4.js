...
title: "Definition",
html: `<ul>
<li><strong>Akute Tonsillitis (Angina tonsillaris):</strong> Akute Entzündung der Gaumenmandeln (Tonsilla palatina) über ihre physiologische Form hinaus mit klinisch relevanter Symptomatik.</li>
</ul>`
},
{
title: "Ursachen",
html: `<ul>
<li><strong>Viren:</strong> Rhino-, Adeno-, Coronaviren, EBV (Mononukleose), Coxsackie-Viren (Herpangina)</li>
<li><strong>Bakterien:</strong> meist <strong>β-hämolysierende Streptokokken der Gruppe A (GAS)</strong>; seltener Staphylokokken, Pneumokokken, H. influenzae</li>
<li><strong>Pilze:</strong> Candida (bei Immunsuppression)</li>
</ul>`
},
{
title: "Symptome",
html: `<ul>
<li>Allgemeines Krankheitsgefühl, Fieber</li>
<li><strong>Halsschmerzen</strong> (oft Ausstrahlung in Ohren), <strong>Schluckbeschwerden</strong> (Dysphagie/Odynophagie)</li>
<li>Zervikale Lymphadenopathie (schmerzhaft)</li>
<li>Foetor ex ore</li>
<li>Tonsillenschwellung und -rötung</li>
<li><strong>Tonsillenbeläge</strong> (Stippchen, fibrinös)</li>
<li>ggf. Exanthem und Himbeerzunge (V.a. Scharlach)</li>
<li>ggf. Hepatosplenomegalie (V.a. EBV)</li>
</ul>`
},
{
title: "Diagnostik",
html: `<h3>Basismaßnahmen</h3>
<ul>
<li>Ersteindruck + ABCDE + Vitalparameter (Fieber?)</li>
<li><strong>Anamnese:</strong> Symptombeginn? Husten/Schnupfen (spricht eher gegen Bakterien)? Fieber? Vorerkrankungen? Immunsuppression? Rheumatisches Fieber?</li>
<li><strong>Körperliche Untersuchung:</strong>
<ul>
<li>Inspektion Rachen: Rötung? Schwellung (einseitig/beidseitig)? Beläge? Uvula-Ödem? Vorwölbung des Gaumenbogens (Abszess?)?</li>
<li>Palpation: Kieferwinkel-Lymphknoten?</li>
<li>Auskultation: Stridor?</li>
</ul>
</li>
</ul>
<h3>Wichtige Differentialdiagnosen & Komplikationen</h3>
<div class="callout callout-wichtig"><p><strong>Klären:</strong> Liegt eine <strong>EBV-Mononukleose</strong> vor? Gibt es Hinweise auf einen <strong>Peritonsillarabszess</strong> (Trismus, einseitige Schwellung)?</p></div>
<h3>Labor/Abstriche</h3>
<ul>
<li><strong>Streptokokken-Schnelltest:</strong> bei Centor-Score ≥ 3–4 erwägen (kein Abstrich bei > 15-Jährigen ohne Risikofaktoren zwingend nötig)</li>
<li>Labor (BB, CRP): bei schwerem Krankheitsbild oder V.a. EBV (atypische Lymphozyten)</li>
<li>Blutkulturen nur bei Sepsisverdacht/Lemierre-Syndrom</li>
</ul>`
},
{
title: "Therapie",
...
<ul>
<li>Körperliche Schonung, ausreichende Flüssigkeitszufuhr</li>
<li>Analgesie: <strong>Ibuprofen</strong> 400 mg 3x/d oder Paracetamol 1 g 3x/d</li>
</ul>
<h3>Indikation für Antibiotikagabe (> 15 Jahre)</h3>
<h3>Entscheidungsbaum</h3>
<ol>
<li><strong>Akute Tonsillitis</strong> → Sind <strong>Red-Flags</strong> vorhanden?
<ul>
<li><strong>Ja:</strong> Individuelles Vorgehen (z.B. sofortige Antibiose, Einweisung)</li>
<li><strong>Nein:</strong> Centor-Score anwenden</li>
</ul>
</li>
<li><strong>Centor-Score Auswertung:</strong>
<ul>
<li><strong>0–2 Punkte:</strong> Kein Antibiotikum</li>
<li><strong>3 Punkte:</strong> Delayed Prescription erwägen (Rezept bei Verschlechterung/Nicht-Besserung nach 3–5 Tagen einlösen)</li>
<li><strong>4 Punkte:</strong> Antibiotikum oder Delayed Prescription</li>
</ul>
</li>
</ol>
<h3>Red-Flags</h3>
<ul>
<li>V.a. Peritonsillarabszess, Scharlach, Immunsuppression, rheumatisches Fieber in Anamnese, schwere Komorbidität, ausgeprägte Beeinträchtigung</li>
</ul>
<h3>Centor-Score (jeweils 1 Punkt)</h3>
<ul>
<li>Tonsillenexsudate</li>
<li>Zervikale Lymphadenopathie</li>
<li>Fieber in der Anamnese > 38°C</li>
<li>Kein Husten</li>
</ul>
<h3>Antibiotische Therapie (bei Indikation)</h3>
<ul>
<li><strong>Mittel der 1. Wahl:</strong> <strong>Penicillin V</strong> 0,8–1,0 Mio. IE 3x/d p.o. für 5–7 Tage</li>
<li>Bei Penicillin-Unverträglichkeit: <strong>Clarithromycin</strong> 250–500 mg 2x/d p.o. für 5 Tage</li>
<li>Ziele: Moderate Symptomverkürzung (ca. 16h), nicht primär Prävention von Komplikationen</li>
</ul>
<h3>Komplikationsmanagement</h3>
<ul>
<li><strong>Exsikkose:</strong> Vollelektrolytlösung i.v.</li>
<li><strong>Peritonsillarabszess:</strong> HNO-Vorstellung zur Entlastung (Punktion/Inzision/Tonsillektomie)</li>
</ul>
<div class="callout callout-cave"><p><strong>CAVE:</strong> Bei V.a. <strong>EBV-Mononukleose</strong> KEINE Aminopenicilline (Ampicillin/Amoxicillin) → Gefahr des Arzneimittelexanthems!</p></div>`
},
{
title: "Merke",
html: `<ul>
<li><strong>Viren</strong> sind die häufigste Ursache</li>
<li><strong>Peritonsillarabszess</strong> erkennen: Einseitige Schwellung, Uvuladeviation, Kieferklemme (Trismus), kloßige Sprache → HNO-Notfall!</li>
<li><strong>Lemierre-Syndrom:</strong> Septische Thrombophlebitis der V. jugularis interna nach Tonsillitis (selten, aber lebensbedrohlich!)</li>
<li>Keine Ansteckungsgefahr 24h nach Beginn wirksamer Antibiose (bei bakterieller Genese)</li>
</ul>`
},
{
title: "Disposition",
html: `<ul>
<li><strong>Ambulant:</strong> Unkomplizierte Tonsillitis ohne Red-Flags, orale Flüssigkeitsaufnahme möglich</li>
<li><strong>Stationär:</strong> Peritonsillarabszess (HNO), Sepsis, starke Schluckunfähigkeit/Exsikkose, Immunsuppression</li>
</ul>`
}
],
stand: "10/24",
sources: `S3-Leitlinie Therapie der Tonsillo-Pharyngitis, AWMF-Register-Nr. 017/024, 2024.<br>DEGAM S3-Leitlinie Halsschmerzen, AWMF-Register-Nr. 053-010, 2020.`
},
{
